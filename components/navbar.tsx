      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-80">
                <DropdownMenuItem>
                  ...
                  <div>
                    <div className="font-semibold">Realtime Delivery</div>
                    <div className="text-sm text-muted-foreground">
                      Arifa delivers notifications instantly with ultra-low
                      latency.
                    </div>
                  </div>
                </DropdownMenuItem>
                ...
                <DropdownMenuItem>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      Track delivery counts, failures, retries, and realtime
                      usage.
                    </div>
                  </div>
                </DropdownMenuItem>
                ...
                <DropdownMenuItem>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      Notifications delivered reliably across the world.
                    </div>
                  </div>
                </DropdownMenuItem>
                ...
                <DropdownMenuItem>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      Built for 99.9% uptime — stay online and stay realtime.
                    </div>
                  </div>
                </DropdownMenuItem>
                ...
                <DropdownMenuItem>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      Clean APIs, great documentation, and easy integrations.
                    </div>
                  </div>
                </DropdownMenuItem>
              </DropdownMenuContent>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button asChild className="hidden sm:flex" size="sm">
              <Link href="https://app.arifa.dev/signin" target="_blank">
                Sign In
              </Link>
            </Button>
            <Button asChild className="hidden sm:flex" size="sm">
              <Link href="https://app.arifa.dev/signup" target="_blank">
                Sign Up
              </Link>
            </Button>
            <ThemeSwitcher />
