  ...
  const testimonials = [
    {
      ...
      content:
        "Arifa completely changed how we handle realtime payment updates. Delivery is instant, reliable, and our support tickets dropped by 40%.",
      rating: 5,
    },
    {
      name: "Daniel Muriuki",
      ...
      content:
        "The latency is insane—sub-100ms everywhere we tested. Integrating Arifa was the easiest part of our migration.",
      rating: 5,
    },
    {
      name: "Sarah Thompson",
      ...
      content:
        "Driver and rider updates are now truly realtime. Our team calls Arifa ‘the invisible engine’ because it just works.",
      rating: 5,
    }
  ];
